...
@Component({
    ...
    template: `
      ...
      <h3>How the game goes on</h3><p>
        ...
        So, each turn consists of two actions: </p><p>1. Place on the board the piece given by the opponent.</p>
      ...
      <h3>Winner</h3><p>The winner is the player who places the fourth piece of the line.</p>
