...
@Component({
    ...
    template: `
      ...
      <h3>How the game goes on</h3><p>Players move alternatively, placing one piece on the board; once inserted, pieces cannot be moved.
      ...
      <p>In the first turn of the game, the player who starts has only to choose one piece for the opponent.</p><h3>Winner</h3>
