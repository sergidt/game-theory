...
@Component({
    ...
    template: `
      ...
      <p>
        ...
        <a href="https://github.com/nartc">Chau Tran (nartc)</a>
        , creator of this library, and the patience he has had during the development of this project.
      </p>

      <h2>Game engine and IA</h2>
      <p>The game is controlled by the implementation of a
        <span class="highlight">state machine</span>
         .
      </p>
      ...
      <p>For the artificial intelligence part, a traditional algorithm has been implemented, called
        <span class="highlight">minimax with alpha beta pruning</span>
         .
      </p>
