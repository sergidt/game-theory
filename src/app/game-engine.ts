...
export class GameEngine {
  ...
  userPointingPiece(characteristics: PieceCharacteristics) {
    if (!this.#boardController.isPlaced(characteristics) && this.currentState() === GameStates.UserSelectingPiece)
  ...
  pieceSelectedByUser(piece: PieceCharacteristics) {
    if (!this.#boardController.isPlaced(piece) && this.currentState() === GameStates.UserSelectingPiece) {
